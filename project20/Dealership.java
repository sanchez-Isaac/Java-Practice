...
public class Dealership {
    ...
    public static void main(String[] args) {
        ...
        //Customer Objects
        Customer cust1 = new Customer("Isaac", "Wake St #741", 18000.00);
        ...
        //Vehicle Objects
        Vehicle car1 = new Vehicle("VW","Vento", 2012, 200, 15000.12);
        Vehicle car2 = new Vehicle("Mazda","3", 2017, 300, 20000.32);

        //This is the most important action
        cust1.purchaseCar(car1, emplo1, finance, cust1);
