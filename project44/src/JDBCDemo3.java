...
public class JDBCDemo3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            rowsAffected = statement.executeUpdate("INSERT INTO employees_tbl (id, name, dept, salary) values (900, 'Robert', 'Sales', 4000)");

            //Process the result
            System.out.println("We executed an Insert Statement. - Rows afected: "+ rowsAffected);
